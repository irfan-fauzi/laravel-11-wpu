<!DOCTYPE html>
<html lang="en" class="h-full dark:bg-gray-900 dark:text-white">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="/content"
                                    class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Content</a>
                        ...
                        <div class="ml-4 flex items-center md:ml-6" x-data="{ open: false }">
                            ...
                            <div x-show="open" @click.away="open = false"
                                ...
                                <a href="#" class="block px-4 py-2 text-sm text-gray-300 hover:bg-white/5">Your
                                    profile</a>
                                <a href="#"
                                    class="block px-4 py-2 text-sm text-gray-300 hover:bg-white/5">Settings</a>
    ...
    x-2 pt-2 pb-3 space-y-1" x-show="mobileOpen"
        ...
        <header
            ...
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-white"> @yield('heading', 'Home')</h1>
            </div>
        </header>
